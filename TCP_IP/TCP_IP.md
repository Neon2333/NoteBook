...
* 标志3bit
  ...
  ![image-20210814030317985](https://i.loli.net/2021/08/14/2GeUzQjhSD6cp5A.png)
...
* 片偏移13bit
  ...
  ![image-20210814030409501](https://i.loli.net/2021/08/14/C1mFjHinRQcaulZ.png)
...
* [免费/无偿ARP](https://blog.csdn.net/weixin_44523989/article/details/90674403)
  ...
  ![img](https://i.loli.net/2021/08/13/9QTgrAkye6fdJcx.png)
  ...
  ![image-20210813010012582](https://i.loli.net/2021/08/13/hYfWqcxMJe3Qkjl.png)

  ![image-20210813004306906](https://i.loli.net/2021/08/13/YWjhm1UnPMQu9Ry.png)

  若已有主机使用了设置IP，则使用了IP的主机会返回一个ARP reply

  ![img](https://i.loli.net/2021/08/13/ojvwAiU9J7YzcLu.png)
...
* TCP报文段（segment ）格式
  ...
  ![image-20210817233624508](https://i.loli.net/2021/08/17/iNU3OjkApJ58ZgB.png)

  ![image-20210817233803867](https://i.loli.net/2021/08/17/QkgPVq19FoKtx8M.png)
...
* 可靠传输——超时重传机制和等待确认机制
  ...
  >
  >   ![image-20210817233154294](C:/Users/25224/AppData/Roaming/Typora/typora-user-images/image-20210817233154294.png)
...
* `滑动窗口`，包括`发送端窗口`、`接收端窗口rwnd`。在实现上即`缓存`，是内存中的一块空间，**发送端**以3个指针维护四个区域（已确认、已发送未确认、未发送）。
  ...
  >
  >   ![image-20210721231903252](https://i.loli.net/2021/07/21/21RKpn8LHTkMyFa.png)
  >
  ...
  >
  >   ![image-20210721234432288](C:/Users/25224/AppData/Roaming/Typora/typora-user-images/image-20210721234432288.png)
  >
...
* 拥塞控制——发送端维护`拥塞窗口cwnd`，发送端取rwnd和cwnd较小者作为发送窗口大小。**慢开始、快速重传、快速恢复**算法设置cwnd长度（字节）。
  ...
  >
  >   ![image-20210722000528357](https://i.loli.net/2021/07/24/iGdLDSg7C26AtuQ.png)
  >
  >   不使用快重传的情况——如果发送方设置的超时计时器时限已到但还没有收到确认，那么很可能是网络出现了拥塞，致使报文段在网络中的某处被丢弃。这时，TCP马上把拥塞窗口 cwnd 减小到1，并执行慢开始算法，同时把慢开始门限值ssthresh减半。
  >
  >   使用快重传：
  >
  >   ![image-20210722100134441](D:\WorkSpace\工作笔记\TCP_IP\TCP_IP.assets\image-20210722100134441.png)
  >
  > * **快恢复**——与快重传同时使用
  >
  ...
  >
  >   ![在这里插入图片描述](D:\WorkSpace\工作笔记\TCP_IP\TCP_IP.assets\20190604100440751.png)
...
![image-20210722112804983](D:\WorkSpace\工作笔记\TCP_IP\TCP_IP.assets\image-20210722112804983-1626924487014.png)

![image-20210725000401580](https://i.loli.net/2021/07/25/HyGkFW18auCqhSe.png)
